                ...
                <Grid columns="2" stackable textAlign="center" container >
                    <Grid.Row centered>
                        <Grid.Column largeScreen="16" textAlign="center">
                            <Header inverted className="contactHeader" as="h2">Bizimle İletişime Geç</Header>
                        ...
                        <Grid.Column>
                            <Form>
                                <Form.Field className="contactFormInput">
                                    <Form.Input icon="users" focus placeholder="İsim" />
                                </Form.Field>
                                <Form.Field className="contactFormInput">
                                    <Form.Input icon="envelope" focus placeholder="Email" />
                                </Form.Field>
                                <Form.Field className="contactFormInput">
                                    <Form.TextArea rows="6" placeholder="Mesaj" />
                                </Form.Field>
                                <Form.Button color='google plus' labelPosition='right' icon='share' content="Gönder" />
                            </Form>
                        </Grid.Column>
                        ...
                        <Grid.Column verticalAlign="top" textAlign="left">
                            <List>
                                <List.Item>
                                    ...
                                    <List.Content>
                                        <Header className="contactInformationHeader" inverted size="large">Ofis Adresi</Header>
                            ...
                            <List>
                                <List.Item>
                                    ...
                                    <List.Content>
                                        <Header className="contactInformationHeader" inverted size="large">Ofis Numarası</Header>
                            ...
                            <List>
                                <List.Item>
                                    ...
                                    <List.Content>
                                        <Header className="contactInformationHeader" size="large" inverted>İletişim Mail</Header>
